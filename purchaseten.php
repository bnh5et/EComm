            ...
            <div class="aboutus-page">
                ...
                <div>
                    ...
                    <form action="startPayment.php" method="POST">
                        ...
                        <table>
                            <tr><td>Credit </td><td><input class="form-control" type="text" name="camera_amount" value="200" readonly></input></td></tr>
                            <tr><td>Tax </td><td><input class="form-control" type="text" name="tax" value="10" readonly></input> </td></tr>
                            <tr><td>Total Amount </td><td><input class="form-control" type="text" name="total_amount" value="210" readonly></input> </td></tr>
                        </table>
